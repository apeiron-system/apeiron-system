...
export default function JobOrderProgressBillingPage({ auth }) {
    ...
    return (
        ...
        >
            ...
            <div className="flex">
                {/* Sidebar */}
                <div className={`sticky top-0 h-full mt-6 ${isCollapsed ? "w-2/9" : "w-3/6"} transition-all duration-1500`}>
                    <div className="mb-6 flex justify-between items-start">
                        {!isCollapsed && (
                            <div>
                                ...
                                <p className="text-sm text-gray-600">Location: <span className="font-semibold">[Location]</span></p>
